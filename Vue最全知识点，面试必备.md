...
> 声明：本篇文章纯属笔记性文章，非整体原创，是对vue知识的整理，对自己有很大帮助才分享出来。
...
- Vue 数据双向绑定主要是指：**数据变化更新视图，视图变化更新数据**。其中，View变化更新Data，可以w通过事件监听的方式来实现，所以 Vue数据双向绑定的工作主要是如何**根据Data变化更新View**。
...
![img](https://mmbiz.qpic.cn/mmbiz/vO7l6lQ0Bwq2829qUe0eb3DAFt2NaZXwh2LQ2GyXusBhTIFx6hwLOZiaNsGYDfEIC297oNSzU4X2B5A4VovHZEQ/640?wx_fmt=other&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
